...
class ProduitRepository extends EntityRepository {
    ...
    public function getAllSuggestions(\Entity\Produit $produit) {
        ...
        $prix_min = $prix - (30*$prix/100); // 70% du prix (diminution de 30%)
        $prix_max = $prix + (30*$prix/100); // 130% du prix initial

        $requete = "SELECT * FROM produit WHERE categorie = '$categorie' AND prix BETWEEN $prix_min AND $prix_max AND public = '$public' AND id_produit != '$id_produit' ";
